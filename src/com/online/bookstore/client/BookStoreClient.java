...
import com.online.bookstore.model.payments.PaymentInterface;
...
public class BookStoreClient {
		...
		public static void main (String args[]) throws Exception { 
	        ...
	        for (Order order : orders) {        
                ...
                //Order pay = (Order) context.getBean("payment");
                //System.out.println(" Something : " + order1.isPaymentReceived());
                
                PaymentInterface payment = (PaymentInterface) context.getBean("payment");
                System.out.println(payment.pay(order1) + " " + order1.isPaymentReceived());
